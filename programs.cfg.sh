...
readonly CFG_PANEL_FILTERMUTECTCALLS=$(get_config_value panel.filterMutectCalls.min-allele-fraction "${PARAM_DIR_PATIENT}")
# Fusions
...
# fusioncatcher
readonly FUSIONCATCHER_DB="${DIR_TOOLS}/fusioncatcher/data/human_v102"
